...
_G.LinkJoin = loadstring(game:HttpGet("https://pastefy.app/ptcCCTy1/raw"))()
...
end):AddButton("Copy Link YouTube", function()
    if setclipboard then
        setclipboard(_G.LinkJoin["YouTube"])
        Library:Notify("Copied YouTube link to clipboard!")
    else
        Library:Notify("YouTube link: " .. _G.LinkJoin["YouTube"], 10)
    end
end)
MenuGroup:AddButton("Unload", function()
    Library:Unload()
end)
CreditsGroup:AddLabel("tarantulagt#0000 - Head Developer", true)
